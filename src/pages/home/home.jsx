...
const Home = () => {
  return (
    <S.Home>
      ...
      <S.NavButtonGroup>
        <S.ButtonLabel>
          {`Wondering what you can make with the ingredients you already 
          have?  Simply add ingredients to your fridge and we'll do the 
          rest!`}
        </S.ButtonLabel>
        <S.NavButton>Add ingredients to fridge</S.NavButton>
      </S.NavButtonGroup>
      <S.NavButtonGroup>
        <S.ButtonLabel>
          {`Wondering how to make a particular pasta dish?  Search pasta 
          dishes by name or ingredients and get started!`}
        </S.ButtonLabel>
        <S.NavButton>Browse pasta recipes</S.NavButton>
      </S.NavButtonGroup>
    </S.Home>
  );
}
